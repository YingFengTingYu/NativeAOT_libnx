...
2026-09-09 的完整游戏 ARM32 对象约含 24.8 MiB 托管代码，已通过链接及静态审核。新的跳转布局在 iOS 10.0.2 上通过 8 组运行时探针；游戏界面、资源和具体功能还需单独验证，不能由探针结果推断。相关验证记录见 [2026-09-09](results/2026-09-09.md)。
