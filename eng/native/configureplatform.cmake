...
if(CLR_CMAKE_HOST_OS STREQUAL generic AND CMAKE_SYSTEM_VARIANT STREQUAL libnx)
    if(NOT CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64)
        message(FATAL_ERROR "The experimental libnx target supports AArch64 only")
    endif()
    # CLR host describes the platform on which the compiled runtime runs.
    # Reuse the Unix compiler/ELF machinery without selecting Linux APIs.
    set(CLR_CMAKE_HOST_OS libnx)
...
if(CLR_CMAKE_TARGET_OS STREQUAL libnx)
    if(NOT CLR_CMAKE_TARGET_ARCH STREQUAL arm64)
        message(FATAL_ERROR "The experimental libnx target supports arm64 only")
    endif()
    set(CLR_CMAKE_TARGET_UNIX 1)
